...
$(document).ready(function(){
    ...
    $('.faq-4').click(function(){
         $('.faqopen4').slideToggle()
           })
    
    $('.sign-up-icon').click(function()
    {
      $('.sign-upform').slideToggle();
    ...
    $('#closepopupclose').click(function()
    {
      $('#p1').hide()
    }) 
...
$(function () {
  $('#myButton').floatingWhatsApp({
      ...
      message: "what is the material of",
      showPopup: true,
      showOnIE: false,
      headerTitle: 'Welcome!',
      headerColor: '#25D366',
      backgroundColor: '#b0252c',
